// src/utils/emailTemplates/verification.js
const verificationTemplate = (user, verificationUrl) => {
    return `
        <!DOCTYPE html>
        <html lang="tr">
        <head>
        ...
        <body>
          <div class="container">
            ...
            <p>TuMeal'e hoş geldiniz! Hesabınızı doğrulamak için aşağıdaki butona tıklayın.</p>
